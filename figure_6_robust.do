...
**# Figure 6, parental penalty by sex
capture log close
log using "./tables/sqtreg_table_simple_age3040_10_agefix_kids_f.log", replace nomsg
sqreg ten_y other_ten_y ttrend ttrend2 i.mother_10#c.ttrend i.mother_10#c.ttrend2 i.covid##i.mother_10 ///
  part_time#i.mother_10 college#i.mother_10 less_hs#i.mother_10 ///
   other_se#i.mother_10 other_college#i.mother_10 other_less_hs#i.mother_10 ///
   if ((mother_10==1&wife==1)|(mother_15==0&wife==1))&employed&age3040==1, ///
                q(.25 .5 .75)
log close



log using "./tables/sqtreg_table_simple_age3040_10_agefix_kids_m.log", replace nomsg
sqreg tten_y other_ten_y ttrend ttrend2 i.father_10#c.ttrend i.father_10#c.ttrend2 i.covid##i.father_10 ///
  part_time#i.father_10 college#i.father_10 less_hs#i.father_10 ///
   other_se#i.father_10 other_college#i.father_10 other_less_hs#i.father_10 ///
                if ((father_10==1&husband==1)|(father_15==0&husband==1))&employed&age3040==1, ///
                q(.25 .5 .75)
log close